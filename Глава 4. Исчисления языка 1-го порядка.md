...
<u>Теорема</u> **1**. Формула $P_1^2x_1x_2 \rightarrow P_1^2x_2x_1$ - формальная теорема
...
>
> $((p\land q \rightarrow r) \rightarrow (q\rightarrow r) )$
...
Доказательство: переименовывая вторую аксиому из схемы, можем получить:

$P_1^2x_2x_1 \rightarrow (F(x_2) \rightarrow F(x_1))$

> $(p\rightarrow q) \rightarrow ((q \rightarrow r) \rightarrow(p\rightarrow r))$

Используя теорему 1 получаем вывод.



<u>Теорема</u> **3**. Формула $P_1^2x_1x_2 \rightarrow (P_1^2x_2x_3 \rightarrow P_1^2x_1x_3)$ - формальная теорема.

Доказательство: $F = P_1^2x_2x_3$

$P_1^2x_1x_2 \land (P_1^2x_2x_3 \rightarrow P_1^2x_1x_3)$ 

> какая-то магия с эквивалентностью и конгруентностью



<u>Теорема</u> **4**. Формула $P_1^2x_1x_2 \rightarrow P_1^2f_m^nx_{n+1}x_2...x_nf_m^nx_{n+2}x_2...x_n$ - формальная теорема. 

> *Замена? $x_2$зависит от $x_{n+1}$???*
...
<u>Теорема</u> **5**. Для любой интерпретации теории системы аксиом $\Gamma$, если существует какая-то модель, то существует и нормальная.



> Ё теория -> Е теория (**E**qual)

> У нас появился значок равенества (алфавитный символ)! $x_1=x_2$

$x_1=x_2 \rightarrow (F(x_1) \rightarrow F(x_2))$

Вторая аксиома теории равенства:
...
- $F(f_1^0) \land (F(x_1) \rightarrow F(f_1^1x_1)) \rightarrow F(x_2)$
